...
### Key Highlights
- ⚖️ **Double-Entry General Ledger**: Enforces the invariant Total Debits = Total Credits across all journal postings.
...
- Color-coded variance KPIs: On Track (<= 75%), Warning (75% - 95%), and Exceeded (> 100%).
